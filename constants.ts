...
export const PROPERTIES: Property[] = [
  ...
  },
  {
    ...
    // Additional details for PropertyInfo component
    description:
      'A Masterpiece of Neoclassical Living. "Escape to paradise - where luxury meets tranquility." Featuring a private lawn, swimming pool, and deck areas with seamless indoor-outdoor flow.',
    projectStatus: 'Under Construction (6th project in progress)',
    features: [
      'Private Garden',
