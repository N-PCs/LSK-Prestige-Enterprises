    ...
    <h3 className="m-0 text-sm font-medium tracking-wide">
      ...
      {isMenuOpen && (
        <div className="md:hidden bg-white dark:bg-black border-b border-gray-100 dark:border-gray-900 px-6 py-8 space-y-6 animate-in fade-in slide-in-from-top-4 duration-300">
          <a className="block text-xs font-bold uppercase tracking-widest py-2 hover:text-primary transition-colors" href="#">Home</a>
          <a className="block text-xs font-bold uppercase tracking-widest py-2 hover:text-primary transition-colors" href="#about">About Us</a>
          <a className="block text-xs font-bold uppercase tracking-widest py-2 hover:text-primary transition-colors" href="#properties">Properties</a>
          <a className="block text-xs font-bold uppercase tracking-widest py-2 hover:text-primary transition-colors" href="#services">Services</a>
          <a className="block bg-secondary text-white px-6 py-4 rounded text-xs uppercase tracking-widest font-bold text-center hover:opacity-90 transition-opacity mt-4" href="#contact">Contact Us</a>
        </div>
      )}
    </nav>
  );
