  ...
  return (
    <>
      ...
      <div className="fixed bottom-8 right-8 flex flex-col gap-5 z-[100]">
        <div
          className="bg-secondary text-white w-16 h-16 rounded-full shadow-2xl flex items-center justify-center cursor-pointer hover:scale-110 active:scale-90 transition-all relative group"
