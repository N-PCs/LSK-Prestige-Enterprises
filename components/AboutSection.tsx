      ...
      <div className="max-w-7xl mx-auto flex flex-col lg:flex-row gap-16 items-center">
        ...
        >
          ...
          <div>
            ...
            <p className="text-gray-500 dark:text-gray-400 leading-relaxed mb-6 sm:mb-8 text-xs sm:text-sm font-light italic">
          ...
          <div className="border-t border-gray-100 dark:border-gray-800 pt-6 sm:pt-7 md:pt-8">
            <span className="text-secondary font-bold tracking-[0.4em] text-[10px] uppercase mb-4 block">
              Philosophy / Values
            </span>
            <p className="text-gray-500 dark:text-gray-400 leading-relaxed mb-4 sm:mb-6 text-xs sm:text-sm font-light italic">
